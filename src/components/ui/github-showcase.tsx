...
const GITHUB_USER = "KartikSharma4448";
...
const PINNED_REPOS = [
  ...
  {
    name: "Todoup-flutter",
    desc: "Published on Google Play Store. Modern task management app with AI-assisted task features, smart reminders, Supabase cloud sync, and offline Hive storage.",
    stars: 18,
    forks: 5,
    lang: "Dart",
    url: "https://github.com/KartikSharma4448/Todoup-flutter"
  },
  {
    name: "Pranag-fluter",
    desc: "AI Livestock Diagnostic mobile app with biometric muzzle-print ID, CNN skin disease diagnosis, and MFCC acoustic health screening.",
    stars: 15,
    forks: 4,
    lang: "Flutter",
    url: "https://github.com/KartikSharma4448/Pranag-fluter"
  },
  {
    name: "KidZ-GPT",
    desc: "AI learning assistant for children with interactive 3D animated characters, real-time voice and text AI conversations using Three.js and LLM APIs.",
    stars: 14,
    forks: 3,
    lang: "TypeScript",
    url: "https://github.com/KartikSharma4448/KidZ-GPT"
  },
  {
    name: "Aegiscare",
    desc: "Decentralized healthcare platform on Algorand blockchain with role-based smart contracts and IPFS-based tamper-proof medical records.",
    stars: 12,
    forks: 2,
    lang: "Python",
    url: "https://github.com/KartikSharma4448/Aegiscare"
  },
  {
    name: "Publicportfolios",
    desc: "40+ Free, beautiful, and open-source portfolio website templates for developers and designers with one-click deployment.",
    stars: 45,
    forks: 16,
    lang: "JavaScript",
    url: "https://github.com/KartikSharma4448/Publicportfolios"
  }
];
