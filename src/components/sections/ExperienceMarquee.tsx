...
const GalleryItem = ({ logoSrc }: { logoSrc: string }) => {
    ...
    const needsInvertInDarkMode = logoSrc.includes("McKinsey") ||
        ...
        logoSrc.includes("exin") ||
        logoSrc.includes("infosphere") ||
        logoSrc.includes("persevex") ||
        logoSrc.includes("microsoftlearn") ||
        logoSrc.includes("dinas-pangan");

    const needsWhiteBgRemovalInDarkMode = logoSrc.includes("logobei") || logoSrc.includes("birulangit");

    // FlyRank and LinkedIn Learning are white text logos, so they are invisible on light backgrounds. We invert them in Light Mode.
    const needsInvertInLightMode = logoSrc.includes("flyrank") || logoSrc.includes("FlyRank") || logoSrc.includes("linkedinlearning");
...
export default function ExperienceMarquee() {
    ...
    // Row 1: Strictly the 8 authentic uploaded logos
    const row1 = [
        "/assets/infosphere.png",
        "/assets/vmou.png",
        "/assets/exin.png",
        "/assets/anukritiprakashan.png",
        "/assets/sploinkai.png",
        "/assets/petsgo.png",
        "/assets/vgulogo.png",
        "/assets/genzaawara.png"
    ];

    // Row 2: Strictly the 6 authentic uploaded logos
    const row2 = [
        "/assets/persevex.png",
        "/assets/gdg.png",
        "/assets/coursera.png",
        "/assets/linkedinlearning.png",
        "/assets/googleskills.png",
        "/assets/microsoftlearn.png"
    ];
