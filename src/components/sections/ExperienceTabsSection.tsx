...
import { GraduationCap, Briefcase, Rocket, ChevronDown, ChevronRight, Calendar, MapPin, FileText, ExternalLink } from 'lucide-react';
                                        ...
                                        {exp.certificateUrl && (
                                            <div className="mt-3 pt-2">
                                                <button
                                                    ...
                                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 transition-all duration-200 group cursor-pointer"
                                                >
                                                    <FileText className="w-3.5 h-3.5" />
                                                    <span>{exp.certificateLabel || "View Verified Certificate"}</span>
                                                    <span className="text-[10px] px-1 py-0.2 rounded bg-emerald-500/20 font-sans font-normal opacity-80 group-hover:opacity-100">
                                                        Preview
                                                    </span>
                                                </button>
                                            </div>
