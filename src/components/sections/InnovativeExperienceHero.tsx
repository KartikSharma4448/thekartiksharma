...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        ...
        { label: 'Coursera Certified', description: 'Advanced full-stack algorithms, data structures & Python systems.', orbitIndex: 0, position: 0.85, imageUrl: "/assets/coursera.png" },
        { label: 'LinkedIn Learning', description: 'Enterprise web paradigms, MERN engineering & system design.', orbitIndex: 1, position: 0.05, imageUrl: "/assets/linkedinlearning.png" },
    ],
    journey: [
        { label: 'PRANAG AI Lead', description: 'PetsGo Pvt. Ltd. - End-to-end FastAPI backend & PostgreSQL platform.', orbitIndex: 0, position: 0.15, imageUrl: "/assets/petsgo.png" },
        { label: 'Livestock AI Mobile', description: 'PetsGo - Flutter & on-device TFLite diagnostic application.', orbitIndex: 1, position: 0.35, imageUrl: "/assets/petsgo.png" },
        { label: 'Lead Web Developer', description: 'Anukriti Prakashan - Owned full lifecycle of e-commerce & finance system.', orbitIndex: 0, position: 0.55, imageUrl: "/assets/anukritiprakashan.png" },
        { label: 'Backend Developer', description: 'Gen Z Aawara (ACIC VGU) - High-throughput REST APIs in Node & Express.', orbitIndex: 1, position: 0.75, imageUrl: "/assets/genzaawara.png" },
        { label: 'Hackathon Finalist', description: 'AceHack 5.0 - Led Team Akatsuki to build production AI prototypes.', orbitIndex: 0, position: 0.9, imageUrl: "/assets/vgulogo.png" },
        { label: 'GDG Contributor', description: 'Google Developer Groups - Community collaboration & tech innovation.', orbitIndex: 1, position: 0.02, imageUrl: "/assets/gdg.png" },
    ],
    experience: [
        { label: 'PRANAG AI Web', description: 'Full stack AI platform with Prompt Parser, PINN models & microservices.', orbitIndex: 0, position: 0.2, imageUrl: "/assets/petsgo.png" },
        { label: 'Biometric AI App', description: 'Muzzle-print computer vision & acoustic health diagnostic system in Flutter.', orbitIndex: 1, position: 0.45, imageUrl: "/assets/petsgo.png" },
        { label: 'Sploink (US)', description: 'Frontend Developer Intern (Paid $5/hr) - React.js UI architecture, reusable components & API integration.', orbitIndex: 0, position: 0.6, imageUrl: "/assets/sploinkai.png" },
        { label: 'Anukriti Platform', description: 'Production e-commerce system with automated Python finance tracking.', orbitIndex: 1, position: 0.8, imageUrl: "/assets/anukritiprakashan.png" },
        { label: 'Gen Z Aawara API', description: 'Optimized server-side architecture and responsive backend services.', orbitIndex: 0, position: 0.95, imageUrl: "/assets/genzaawara.png" },
        { label: 'Infosphere Systems', description: 'Scalable cloud-ready platforms and robust developer tooling.', orbitIndex: 1, position: 0.1, imageUrl: "/assets/infosphere.png" },
    ]
};
