...
function BlogContent() {
    ...
    return (
        <main className="min-h-screen bg-background selection:bg-primary/30">
            {/* HERO HEADER - Static & Direct */}
            <header className="pt-28 md:pt-36 pb-8 flex flex-col items-center justify-center">
                <div className="max-w-5xl mx-auto text-center px-4">
                    <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-black text-foreground leading-tight tracking-[-0.04em] uppercase whitespace-nowrap">
                    ...
                    <p className="mt-6 text-[11px] md:text-sm font-medium text-muted-foreground/80 max-w-3xl mx-auto leading-relaxed tracking-wide">
            ...
            {/* Blog Cards Content */}
            <div className="relative z-20 pt-6 pb-24 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-background via-background/80 to-background dark:from-black dark:via-black dark:to-black">
                {/* Background Effects */}
                {!isLowPowerMode && (
                ...
                <div className="container mx-auto relative z-10">
                    ...
                    >
                        {/* High-Performance Framer Motion Cursor Portaled to Body */}
                        {mounted && typeof document !== 'undefined' && createPortal(
                            ...
                            >
                                <div className="flex flex-col items-center text-center -translate-x-1/2 -translate-y-1/2 leading-[1.05] select-none pointer-events-none">
                                    <span className="text-[28px] md:text-[34px] font-black text-white uppercase tracking-[0.2em] drop-shadow-md">
                                        Read
                                    </span>
                                    <span className="text-[28px] md:text-[34px] font-black text-white uppercase tracking-[0.2em] drop-shadow-md">
                                        Detail
