...
<img src="public/favicon.svg" alt="Kartik Sharma Logo" width="80" height="80" />

# Kartik Sharma — Full Stack & MERN Stack Portfolio

### Building Scalable Web Architectures, Modern Mobile Apps & Cloud Solutions
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/KartikSharma4448/thekartiksharma.git
   cd thekartiksharma
   ```
...
The platform showcases production-grade projects spanning multiple engineering disciplines:

| Discipline | Notable Projects | Core Technologies |
|------------|------------------|-------------------|
| **Full Stack & Web** | VCC ERP, Rajasthali Tours, RestroQR, CVCraft | Next.js, React, Node.js, Express, MongoDB, Supabase, Tailwind CSS |
| **Mobile App Development** | Pranag AI, TodoUp, Hope Paws | Flutter, Dart, Supabase, Hive |
| **AI Systems & Vision** | AutoMagic Vision, KidZ GPT | Python, FastAPI, Next.js |
...
<div align="center">
  <p>Engineered by Kartik Sharma</p>
</div>
